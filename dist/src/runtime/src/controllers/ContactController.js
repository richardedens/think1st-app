...
var ContactController = /** @class */ (function () {
    ...
    ContactController.show = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var twingEngine, loggedin;
        return __generator(this, function (_a) {
            twingEngine = new TwingEngine_1.default();
            loggedin = req.session.loggedin || false;
            twingEngine.render("contact.twig", {
                title: "Forgiveness Online Webinar - Contact",
