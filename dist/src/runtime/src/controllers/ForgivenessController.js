...
var ForgivenessController = /** @class */ (function () {
    function ForgivenessController() {
    }
    ForgivenessController.show = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var twingEngine, loggedin;
        return __generator(this, function (_a) {
            twingEngine = new TwingEngine_1.default();
            loggedin = req.session.loggedin || false;
            twingEngine.render("forgiveness.twig", {
                title: "Forgiveness Online Webinar - Forgiveness",
    ...
    return ForgivenessController;
}());
exports.default = ForgivenessController;
//# sourceMappingURL=ForgivenessController.js.map